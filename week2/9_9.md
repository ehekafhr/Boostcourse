...
$$ \traingledown_{\beta} \Vert \mathbf{y} - \mathbf{X} \beta \Vert_{2}^{2} = (\partial_{\beta_1}  \Vert \mathbf{y} - \mathbf{X} \beta \Vert_{2}^{2}, ... , \partial_{\beta_d} \Vert \mathbf{y} - \mathbf{X} \beta \Vert_{2}^{2} $$
